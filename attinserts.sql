...
('Pepperoni', 'Salgada', 'Pepperoni com Queijo', 49.99, 'img/cardapio/pepperoni.jpg') ;


INSERT INTO produtos (nome, categoria, descricao, preco, imagem) VALUES
('Morango com Nutella', 'Doce', 'Chocolate e Morangos cobertos com Leite em Pó', 49.99, 'imgs/cardapio/morango.jpeg'),
('Chocolate com Gotas de Chocolate', 'Doce', 'Pizza doce com chocolate e gotas de chocolate', 49.90, 'imgs/cardapio/gotas-chocolate.png'),
('Pizza com Bombom', 'Doce', 'Chocolate, Chocolate Branco, Confetes e Bombons', 49.90, 'imgs/cardapio/bombom.png'),
('Brigadeiro com Granulado', 'Doce', 'Chocolate com Granulados, Contornados por Avelã e Cerejas', 49.90, 'imgs/cardapio/chocolate-granulado.png'),
('Chocolate com Marshmallow', 'Doce', 'Marshmellow Tostados com Morango', 55.90, 'imgs/cardapio/Marshmello.png' ),
('Chocolate com M&M', 'Doce', 'Chocolate com M&M e Cobertura de Morango', 55.90, 'imgs/cardapio/M&M.png');
